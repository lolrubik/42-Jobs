...
public class ejercicio16 
{
	public static void main(String[] args) 
	{
		...
		boolean diaTrue = dia.equals("lunes") || dia.equals("martes") || dia.equals("miercoles") || dia.equals("jueves") || dia.equals("viernes") || dia.equals("sabado") || dia.equals("domingo");
		
		if (hora >= 0 && hora < 24 && minuto >= 0 && minuto < 60 && diaTrue) 
		{
			if (dia.equals("lunes")) 
			{
